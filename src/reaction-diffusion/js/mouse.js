...
export function setupMouse () {
  ...
  window.addEventListener('mousemove', (e) => {
    ...
    const leftSide = window.innerWidth / 2 - canvas.width / 2
    const rightSide = window.innerWidth / 2 + canvas.width / 2
    const topSide = window.innerHeight / 2 - canvas.height / 2
    const bottomSide = window.innerHeight / 2 + canvas.height / 2
